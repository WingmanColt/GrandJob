...
namespace HireMe.Utility
{
    public static class MobileDetector
    {
        ...
        static Regex TabletCheck = new Regex("Tablet|iPad|PlayBook|BB10|Z30|Nexus 10|Nexus 7|GT-P|SCH-I800|Xoom|Kindle|Silk|KFAPWI", RegexOptions.IgnoreCase);
        public static bool IsMobile(HttpContext context)
        {
            Debug.Assert(context != null);

            if (context != null && context.Request.Headers["User-Agent"].ToString() != null)
            {
                var u = context.Request.Headers["User-Agent"].ToString().ToString();
